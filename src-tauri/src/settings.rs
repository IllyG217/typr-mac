...
pub struct Settings {
    ...
    pub hotkey: String,
    #[serde(rename = "pushToTalkMouseBtn", default)]
    pub push_to_talk_mouse_btn: Option<u32>,
    #[serde(rename = "handsFreeMouseBtn", default)]
    pub hands_free_mouse_btn: Option<u32>,
}
...
impl Default for Settings {
    fn default() -> Self {
        Self {
            ...
            push_to_talk_mouse_btn: None,
            hands_free_mouse_btn: None,
        }
    }
}
